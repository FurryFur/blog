  ...
  with tf.train.MonitoredTrainingSession(
    ...
    while True:
      ...
      cur_lod = np.piecewise(float(steps_at_cur_lod),
                            [         steps_at_cur_lod < 2000 , 2000  <= steps_at_cur_lod < 4000,
                             4000  <= steps_at_cur_lod < 6000 , 6000  <= steps_at_cur_lod < 8000,
                             8000  <= steps_at_cur_lod < 10000, 10000 <= steps_at_cur_lod < 12000,
                             12000 <= steps_at_cur_lod < 14000, 14000 <= steps_at_cur_lod < 16000,
                             16000 <= steps_at_cur_lod < 18000, 18000 <= steps_at_cur_lod < 20000,
                             20000 <= steps_at_cur_lod < 22000, 22000 <= steps_at_cur_lod < 24000,
                             24000 <= steps_at_cur_lod < 26000, 26000 <= steps_at_cur_lod < 28000,
                             28000 <= steps_at_cur_lod < 30000, 30000 <= steps_at_cur_lod < 32000,
                             32000 <= steps_at_cur_lod < 34000, 34000 <= steps_at_cur_lod < 36000,
                             36000 <= steps_at_cur_lod < 38000, 38000 <= steps_at_cur_lod < 40000,
                             40000 <= steps_at_cur_lod < 42000, 42000 <= steps_at_cur_lod < 44000,
                             44000 <= steps_at_cur_lod < 46000, 46000 <= steps_at_cur_lod < 48000],
                            [0,  lambda x: smoothstep((x - 2000 ) / 2000, 0, 1),
                             1,  lambda x: smoothstep((x - 6000 ) / 2000, 1, 2),
                             2,  lambda x: smoothstep((x - 10000) / 2000, 2, 3),
                             3,  lambda x: smoothstep((x - 14000) / 2000, 3, 4),
                             4,  lambda x: smoothstep((x - 18000) / 2000, 4, 5),
                             5,  lambda x: smoothstep((x - 22000) / 2000, 5, 6),
                             6,  lambda x: smoothstep((x - 26000) / 2000, 6, 7),
